...
{
  new (message_memory) msg05_base::msg::Target(_init);
}

void Target_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg05_base::msg::Target *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Target_message_member_array[3] = {
  {
    ...
    offsetof(msg05_base::msg::Target, action),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg05_base::msg::Target, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg05_base::msg::Target, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<msg05_base::msg::Target>()
{
  return &::msg05_base::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg05_base, msg, Target)() {
  return &::msg05_base::msg::rosidl_typesupport_introspection_cpp::Target_message_type_support_handle;
}
