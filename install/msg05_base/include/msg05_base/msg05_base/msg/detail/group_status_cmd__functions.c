...
msg05_base__msg__GroupStatusCmd__create()
{
  ...
  msg05_base__msg__GroupStatusCmd * msg = (msg05_base__msg__GroupStatusCmd *)allocator.allocate(sizeof(msg05_base__msg__GroupStatusCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg05_base__msg__GroupStatusCmd));
  bool success = msg05_base__msg__GroupStatusCmd__init(msg);
  if (!success) {
...
msg05_base__msg__GroupStatusCmd__destroy(msg05_base__msg__GroupStatusCmd * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    msg05_base__msg__GroupStatusCmd__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
msg05_base__msg__GroupStatusCmd__Sequence__init(msg05_base__msg__GroupStatusCmd__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg05_base__msg__GroupStatusCmd * data = NULL;

  if (size) {
    data = (msg05_base__msg__GroupStatusCmd *)allocator.zero_allocate(size, sizeof(msg05_base__msg__GroupStatusCmd), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg05_base__msg__GroupStatusCmd__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msg05_base__msg__GroupStatusCmd__fini(&data[i - 1]);
      }
...
msg05_base__msg__GroupStatusCmd__Sequence__fini(msg05_base__msg__GroupStatusCmd__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msg05_base__msg__GroupStatusCmd__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg05_base__msg__GroupStatusCmd__Sequence * array = (msg05_base__msg__GroupStatusCmd__Sequence *)allocator.allocate(sizeof(msg05_base__msg__GroupStatusCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msg05_base__msg__GroupStatusCmd__Sequence__init(array, size);
  if (!success) {
...
msg05_base__msg__GroupStatusCmd__Sequence__destroy(msg05_base__msg__GroupStatusCmd__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msg05_base__msg__GroupStatusCmd__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msg05_base__msg__GroupStatusCmd__Sequence__are_equal(const msg05_base__msg__GroupStatusCmd__Sequence * lhs, const msg05_base__msg__GroupStatusCmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msg05_base__msg__GroupStatusCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msg05_base__msg__GroupStatusCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msg05_base__msg__GroupStatusCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msg05_base__msg__GroupStatusCmd * data =
      (msg05_base__msg__GroupStatusCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msg05_base__msg__GroupStatusCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msg05_base__msg__GroupStatusCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msg05_base__msg__GroupStatusCmd__copy(
