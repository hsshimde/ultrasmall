...
{
  new (message_memory) msg05_base::msg::Error(_init);
}

void Error_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg05_base::msg::Error *>(message_memory);
  typed_message->~Error();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Error_message_member_array[1] = {
  {
    ...
    offsetof(msg05_base::msg::Error, error),  // bytes offset in struct
...
get_message_type_support_handle<msg05_base::msg::Error>()
{
  return &::msg05_base::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg05_base, msg, Error)() {
  return &::msg05_base::msg::rosidl_typesupport_introspection_cpp::Error_message_type_support_handle;
}
