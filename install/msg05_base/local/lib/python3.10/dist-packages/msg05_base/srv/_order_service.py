...
class Metaclass_OrderService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from msg05_base.srv import _order_service
...
class OrderService(metaclass=Metaclass_OrderService):
    from msg05_base.srv._order_service import OrderService_Request as Request
    from msg05_base.srv._order_service import OrderService_Response as Response
