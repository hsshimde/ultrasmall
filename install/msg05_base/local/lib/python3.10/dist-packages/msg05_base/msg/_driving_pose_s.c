...
bool msg05_base__msg__vector4_f32__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool msg05_base__msg__driving_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._driving_pose.DrivingPose", full_classname_dest, 40) == 0);
  }
  msg05_base__msg__DrivingPose * ros_message = _ros_message;
  {  // id
  ...
  {  // orientation
    ...
    if (!msg05_base__msg__vector4_f32__convert_from_py(field, &ros_message->orientation)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DrivingPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._driving_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DrivingPose");
  ...
  {  // orientation
    PyObject * field = NULL;
    field = msg05_base__msg__vector4_f32__convert_to_py(&ros_message->orientation);
    if (!field) {
      return NULL;
    }
    {
