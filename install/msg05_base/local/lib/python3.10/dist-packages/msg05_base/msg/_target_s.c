...
bool msg05_base__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._target.Target", full_classname_dest, 29) == 0);
  }
  msg05_base__msg__Target * ros_message = _ros_message;
  {  // action
  ...
  {  // position
    ...
    if (!msg05_base__msg__vector3_f32__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // theta
    ...
    assert(PyLong_Check(field));
    ros_message->theta = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * msg05_base__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._target");
  ...
  {  // position
    PyObject * field = NULL;
    field = msg05_base__msg__vector3_f32__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
