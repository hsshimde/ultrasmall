...
bool msg05_base__msg__vector3_i16__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._vector3_i16.Vector3I16", full_classname_dest, 38) == 0);
  }
  msg05_base__msg__Vector3I16 * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Vector3I16 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._vector3_i16");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vector3I16");
