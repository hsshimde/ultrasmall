...
bool msg05_base__msg__vector3_f32__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool msg05_base__msg__driving_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._driving_target.DrivingTarget", full_classname_dest, 44) == 0);
  }
  msg05_base__msg__DrivingTarget * ros_message = _ros_message;
  {  // pose
    PyObject * field = PyObject_GetAttrString(_pymsg, "pose");
    if (!field) {
      return false;
    }
    if (!msg05_base__msg__driving_pose__convert_from_py(field, &ros_message->pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // linear
    ...
    if (!msg05_base__msg__vector3_f32__convert_from_py(field, &ros_message->linear)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // angular
    ...
    if (!msg05_base__msg__vector3_f32__convert_from_py(field, &ros_message->angular)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of DrivingTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._driving_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DrivingTarget");
  ...
  {  // pose
    PyObject * field = NULL;
    field = msg05_base__msg__driving_pose__convert_to_py(&ros_message->pose);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // linear
    PyObject * field = NULL;
    field = msg05_base__msg__vector3_f32__convert_to_py(&ros_message->linear);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // angular
    PyObject * field = NULL;
    field = msg05_base__msg__vector3_f32__convert_to_py(&ros_message->angular);
    if (!field) {
      return NULL;
    }
    {
