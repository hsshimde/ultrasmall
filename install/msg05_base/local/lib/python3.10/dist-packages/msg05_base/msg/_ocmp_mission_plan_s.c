...
bool msg05_base__msg__ocmp_mission_plan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._ocmp_mission_plan.OCMPMissionPlan", full_classname_dest, 49) == 0);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * msg05_base__msg__ocmp_mission_plan__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of OCMPMissionPlan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._ocmp_mission_plan");
