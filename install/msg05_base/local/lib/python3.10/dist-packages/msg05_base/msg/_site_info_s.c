...
bool msg05_base__msg__site_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._site_info.SiteInfo", full_classname_dest, 34) == 0);
  }
  msg05_base__msg__SiteInfo * ros_message = _ros_message;
  {  // points
    ...
    if (!msg05_base__msg__PointI16__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create msg05_base__msg__PointI16__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    msg05_base__msg__PointI16 * dest = ros_message->points.data;
...
{
  /* NOTE(esteve): Call constructor of SiteInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._site_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SiteInfo");
