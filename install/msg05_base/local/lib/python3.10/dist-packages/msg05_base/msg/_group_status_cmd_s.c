...
bool msg05_base__msg__group_status_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._group_status_cmd.GroupStatusCmd", full_classname_dest, 47) == 0);
  }
  msg05_base__msg__GroupStatusCmd * ros_message = _ros_message;
  {  // group_id
...
{
  /* NOTE(esteve): Call constructor of GroupStatusCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._group_status_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GroupStatusCmd");
