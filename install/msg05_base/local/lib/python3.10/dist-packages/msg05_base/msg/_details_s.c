...
bool msg05_base__msg__details__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._details.Details", full_classname_dest, 31) == 0);
  }
  msg05_base__msg__Details * ros_message = _ros_message;
  {  // task
...
{
  /* NOTE(esteve): Call constructor of Details */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._details");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Details");
