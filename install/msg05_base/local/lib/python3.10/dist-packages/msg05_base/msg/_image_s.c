...
bool msg05_base__msg__image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._image.Image", full_classname_dest, 27) == 0);
  }
  msg05_base__msg__Image * ros_message = _ros_message;
  {  // id
...
PyObject * msg05_base__msg__image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._image");
