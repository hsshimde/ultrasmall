...
bool msg05_base__msg__swarm_groups__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg05_base.msg._swarm_groups.SwarmGroups", full_classname_dest, 40) == 0);
  }
  msg05_base__msg__SwarmGroups * ros_message = _ros_message;
  {  // platform_id
...
{
  /* NOTE(esteve): Call constructor of SwarmGroups */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg05_base.msg._swarm_groups");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwarmGroups");
